 ...
 *
 * The followings are the available columns in table 'tipo_reactivo':
 * @property string $id
 ...
 */
class TipoReactivo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TipoReactivo the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider('TipoReactivo', array(
			'criteria'=>$criteria,
		));
	}
}