...
/**
 * This is the model class for table "nivel_cognitivo".
 *
 * The followings are the available columns in table 'nivel_cognitivo':
 * @property string $id
 ...
 */
class nivel_cognitivo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return nivel_cognitivo the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider('nivel_cognitivo', array(
			'criteria'=>$criteria,
		));
	}
}
