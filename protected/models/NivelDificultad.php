...
/**
 * This is the model class for table "nivel_dificultad".
 *
 * The followings are the available columns in table 'nivel_dificultad':
 * @property string $id
 ...
 */
class NivelDificultad extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return NivelDificultad the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider('NivelDificultad', array(
			'criteria'=>$criteria,
		));
	}
}