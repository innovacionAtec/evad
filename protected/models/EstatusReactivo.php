...
/**
 * This is the model class for table "estatus_reactivo".
 *
 * The followings are the available columns in table 'estatus_reactivo':
 * @property string $id
 ...
 */
class EstatusReactivo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return EstatusReactivo the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider('EstatusReactivo', array(
			'criteria'=>$criteria,
		));
	}
}