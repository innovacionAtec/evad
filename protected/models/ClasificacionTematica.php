...
/**
 * This is the model class for table "clasificacion_tematica".
 *
 * The followings are the available columns in table 'clasificacion_tematica':
 * @property string $id
 ...
 */
class ClasificacionTematica extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ClasificacionTematica the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider('ClasificacionTematica', array(
			'criteria'=>$criteria,
		));
	}
}