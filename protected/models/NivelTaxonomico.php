...
/**
 * This is the model class for table "nivel_taxonomico".
 *
 * The followings are the available columns in table 'nivel_taxonomico':
 * @property string $id
 ...
 */
class NivelTaxonomico extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return NivelTaxonomico the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider('NivelTaxonomico', array(
			'criteria'=>$criteria,
		));
	}
}