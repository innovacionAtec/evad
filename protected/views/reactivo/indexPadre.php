...
<?php
    /*TITULO NAVEGADOR*/
    $this->pageTitle = CHtml::encode('EVAD | Reactivos padres');
?>
...
/*TABLE INITIALISATION*/
    ...
    $(document).ready(function() {
        ...
        $("tfoot input").focus( function () {
            if ( this.className == "input-small" )
            {
                this.className = "input-small";//respetar ancho de input
                this.value = "";
            }
        } );
            ...
            "fnInitComplete": function() {
                ...
                for ( var i=0 ; i<oSettings.aoPreSearchCols.length ; i++ ){
                    if(oSettings.aoPreSearchCols[i].sSearch.length>0){
                        ...
                        $("tfoot input")[i].className = "input-small";//respetar ancho de input
                    }
                }
            }
        } );
...
<div class="row">
    <div class="span5">
        <ul class="breadcrumb">
            ...
            <li class="active">Reactivos padres</li>
        </ul>
    </div>
</div>
...
<div class="row"style="margin-bottom:15px;">
    ...
    <div class="span4">
        ...
        <a href="<?php echo CController::createUrl('reactivo/create', array('tipo' => 'padre')); ?>" class="btn btn-inverse" data-content="Permite crear reactivo padre" rel="popover" data-original-title="Ayuda"><!--13abr12_Cirenia-->
            <i class="icon-plus-sign icon-white"></i> Crear reactivo padre
        </a>
        <a href="<?php echo CController::createUrl('index'); ?>" class="btn btn-inverse" data-content="Permite ver los reactivos independientes" rel="popover" data-original-title="Ayuda"><!--13abr12_Cirenia-->
            <i class="icon-search icon-white"></i> Ver independientes
        </a>
    </div>
</div>
...
?>
            ...
            <table id="tabla_inicio" cellpadding="0" cellspacing="0" border="0" class="table" style="margin-top:10px">
                ...
                <tfoot>
                    <tr>
                        <th class="centered"><input class="input-small" type="text" value="Id reactivo"/></th>
                        <th class="centered"><input class="input-small" type="text" value="Planteamiento"/></th>
                        <th class="centered"><input class="input-small" type="text" value="Estado"/></th>
                        <th class="centered"><input class="input-small" type="text" value="Elaborador"/></th>
                        <th class="centered"><input class="input-small" type="text" value="Fecha modificación"/></th>
                    </tr>
                </tfoot>
                <tbody>
                    <?php
