...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_desempeno'); ?>
		<?php echo $form->textField($model,'id_desempeno'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'id_nivel_cognitivo'); ?>
		<?php echo $form->textField($model,'id_nivel_cognitivo'); ?>
	</div>
