...
class DesempenoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['desempeno'];
	...
	{
		$dataProvider=new CActiveDataProvider('desempeno');
	...
	{
		$model=new desempeno('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['desempeno']))
			$model->attributes=$_GET['desempeno'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=desempeno::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='desempeno-form')
		{
