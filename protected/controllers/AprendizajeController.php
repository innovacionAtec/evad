...
class AprendizajeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation($model);
                ...
                $resultado = nivel_cognitivo::model()->findAll();

                $nivel_cognitivo = array();

                $nivel_cognitivo['falso'] = 'Selecciona nivel cognitivo';
                foreach ($resultado as $key => $value) {
		...
		{
			$model->attributes=$_POST['aprendizaje'];
	...
	{
		$dataProvider=new CActiveDataProvider('aprendizaje');
	...
	{
		$model=new aprendizaje('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['aprendizaje']))
			$model->attributes=$_GET['aprendizaje'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=aprendizaje::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='aprendizaje-form')
		{
